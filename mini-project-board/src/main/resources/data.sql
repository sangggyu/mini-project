...
-- 123 게시글
insert into article (user_account_user_id, title, content, hashtag, created_by, modified_by, created_at, modified_at)
...
;
-- 1000 댓글
insert into article_comment (article_id, user_account_user_id, content, created_at, modified_at, created_by, modified_by)
values (49, 1,
        'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.',
