package com.example.miniprojectboard.service;
...
import com.example.miniprojectboard.repository.ArticleRepository;
...
class ArticleServiceTest {
    ...
    void givenNothing_whenCalling_thenReturnsHashtags() {
        ...
        given(articleRepository.findAllDistincHashtag()).willReturn(expectedHashtags);
        ...
        then(articleRepository).should().findAllDistincHashtag();
    }
